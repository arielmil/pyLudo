...
class Testa_Partida(unittest.TestCase):
    def test_01_Conecta_SGBD_OK(self):
        ...
        db = type(Banco_de_dados.Conecta_SGBD("localhost", "ariel", "123456789"))
        retorno_esperado = Banco_de_dados.mysql.connection_cext.CMySQLConnection
    ...
    def test_02_Conecta_SGBD_debug_NOK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localghost", "ariel", "123456789", True)
        retorno_esperado = -1
    ...
    def test_03_Conecta_SGBD_debug_NOK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localhost", "aiel", "123456789", True)
        retorno_esperado = -2
    ...
    def test_04_Conecta_SGBD_debug_NOK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localhost", "ariel", "12345678910", True)
        retorno_esperado = -2
    ...
    def test_05_Cria_Cursor_OK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localhost", "ariel", "123456789")
        cursor = type(Banco_de_dados.Cria_Cursor(db))
        retorno_esperado = Banco_de_dados.mysql.cursor_cext.CMySQLCursorPrepared
    ...
    def test_06_Cria_Cursor_NOK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localghost", "ariel", "123456789", True)
        cursor = Banco_de_dados.Cria_Cursor(db)
        retorno_esperado = -1
    ...
    def test_09_Cria_Tabela_OK(self):
        ...
        db.database = "pyLudo"
        cursor = Banco_de_dados.Cria_Cursor(db)
        checagem = Banco_de_dados.Cria_Tabela(cursor)
    ...
    def test_10_Cria_Tabela_OK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localhost", "ariel", "123456789", True)
        db.database = "pyLudo"
        cursor = Banco_de_dados.Cria_Cursor(db)
        checagem = Banco_de_dados.Cria_Tabela(cursor, True)
    ...
    def test_12_Cria_Banco_OK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localhost", "ariel", "123456789")
        cursor = Banco_de_dados.Cria_Cursor(db)
        checagem = Banco_de_dados.Cria_Banco(cursor)
    ...
    def test_13_Cria_Banco_OK(self):
        ...
        db = Banco_de_dados.Conecta_SGBD("localhost", "ariel", "123456789", True)
        cursor = Banco_de_dados.Cria_Cursor(db)
        checagem = Banco_de_dados.Cria_Banco(cursor, True)
    ...
    def test_15_Exporta_conexao_OK(self):
        ...
        conexao = Banco_de_dados.Exporta_Conexao()
    ...
    def test_16_Deleta_Informacoes_OK(self):
        ...
        db = Banco_de_dados.Exporta_Conexao()
        retorno_esperado = 0
        checa = Banco_de_dados.Deleta_Informacoes(db)
    ...
    def test_17_Deleta_Informacoes_NOK(self):
        ...
        db = {"cursor": -1}
        retorno_esperado = -2
        checa = Banco_de_dados.Deleta_Informacoes(db, True)
    ...
    def test_18_Salva_Jogador_OK(self):
        ...
        peoes = Peao.Cria_peoes("vermelho")
        jogador = [player,peoes]

        checa = Banco_de_dados.Salva_Jogador(db, jogador)
        ...
        Banco_de_dados.Deleta_Informacoes(db)
    ...
    def test_19_Salva_Jogador_NOK(self):
        ...
        checa = Banco_de_dados.Salva_Jogador(db, jogador, True)
        retorno_esperado = -2
    ...
    def test_20_Salva_Jogadores_OK(self):
        ...
        peoes1 = Peao.Cria_peoes("vermelho")
        peoes2 = Peao.Cria_peoes("amarelo")
        peoes3 = Peao.Cria_peoes("azul")
        peoes4 = Peao.Cria_peoes("verde")

        jogadores = [[player1, peoes1],[player2, peoes2],[player3, peoes3],[player4, peoes4]]

        checa = Banco_de_dados.Salva_Jogadores(db, jogadores)
        retorno_esperado = 0
    ...
    def test_21_Salva_Jogadores_NOK(self):
        ...
        checa = Banco_de_dados.Salva_Jogadores(db, jogadores, True)
        retorno_esperado = -2
    ...
    def test_22_Salva_Posicao_Peao_Cor_OK(self):
        ...
        Banco_de_dados.Salva_Jogadores(db, jogadores)
        db["cursor"].execute("SELECT * FROM pyLudo.posicoes")
        antes = db["cursor"].fetchall()
        
        cor = peoes1[0]["cor"]
        checagem = Banco_de_dados.Salva_Posicao_Peao_Cor(db, cor, 0, 1)
    ...
    def test_23_Salva_Posicao_Peao_Cor_NOK(self):
        ...
        cor = peoes1[0]["cor"]
        checagem = Banco_de_dados.Salva_Posicao_Peao_Cor(db, cor, 0, 9, True)
        retorno_esperado = -2
    ...
    def test_24_Pega_Posicao_Peao_Cor_OK(self):
        ...
        cor = peoes1[0]["cor"]
        Banco_de_dados.Salva_Posicao_Peao_Cor(db, cor, 0, 9)

        retorno_esperado = 9
        pos = Banco_de_dados.Pega_Posicao_Peao_Cor(cursor, cor, 0)
    ...
    def test_25_Pega_Posicao_Peao_Cor_NOK(self):
        ...
        cursor = -1
        retorno_esperado = -2
        pos = Banco_de_dados.Pega_Posicao_Peao_Cor(cursor, cor, 0, True)
    ...
    def test_26_Pega_Posicoes_Peoes_Cor_OK(self):
        ...
        cor = peoes1[0]["cor"]
        Banco_de_dados.Salva_Posicao_Peao_Cor(db, cor, 0, 9)
        Banco_de_dados.Salva_Posicao_Peao_Cor(db, cor, 1, 10)
        Banco_de_dados.Salva_Posicao_Peao_Cor(db, cor, 2, 11)
        Banco_de_dados.Salva_Posicao_Peao_Cor(db, cor, 3, 12)
        
        retorno_esperado = [9,10,11,12]
        posicoes = Banco_de_dados.Pega_Posicoes_Peoes_Cor(cursor, cor)
    ...
    def test_27_Pega_Posicoes_Peao_Cor_NOK(self):
        ...
        cursor = -1
        retorno_esperado = -2
        posicoes = Banco_de_dados.Pega_Posicoes_Peoes_Cor(cursor, cor, True)
