...
class Testa_Tabuleiro(unittest.TestCase):
    ...
    def test_01_Cria_tabuleiro_vazio_OK(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 01 - Criar um tabuleiro com 58 casas vazias ")
        retorno_esperado = []
        for i in range(0,58):
    ...
    def test_02_Cria_casa_OK(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 02 - Criar uma casa de tabuleiro com suas coordenadas x e y")
    ...
    def test_03_Cria_casa_NOK_falta_x(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 03 - Falha ao criar casa, valor de x nulo")
        retorno_esperado = -1
        self.assertEqual(retorno_esperado, teste)
    ...
    def test_04_Cria_casa_NOK_falta_y(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 04 - Falha ao criar casa, valor de y nulo")
        retorno_esperado = -1
        self.assertEqual(retorno_esperado, teste)
    ...
    def test_05_Cria_casa_NOK_falta_xy(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 05 - Falha ao criar casa, valor de x e y nulos")
        retorno_esperado = -1
        self.assertEqual(retorno_esperado, teste)
    ...
    def test_06_Cria_casas_OK_varia_x_positivo(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 06 - Cria uma lista de casas do tabuleiro - variando em x - sentido positivo")
    ...
    def test_07_Cria_casas_OK_varia_y_positivo(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 07 - Cria uma lista de casas do tabuleiro - variando em y - sentido positivo")
        retorno_esperado = [{'x': 5, 'y': 2, 'peoes': [], 'semi_torres': [], 'torres': []},
    ...
    def test_08_Cria_casas_OK_varia_x_negativo(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 08 - Cria uma lista de casas do tabuleiro - variando em x - sentido negativo")
    ...
    def test_09_Cria_casas_OK_varia_y_negativo(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 09 - Cria uma lista de casas do tabuleiro - variando em y - sentido negativo")
        retorno_esperado = [{'x': 5, 'y': 2, 'peoes': [], 'semi_torres': [], 'torres': []},
    ...
    def test_10_Cria_casas_NOK_varia_xy(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 10 - Cria uma lista de casas do tabuleiro - variando em x e em y")
        retorno_esperado = -2
        self.assertEqual(retorno_esperado, teste)
    ...
    def test_11_Cria_casas_NOK_sem_xy(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 11 - Cria uma lista de casas do tabuleiro caso x e y são nulos")
        retorno_esperado = []        
        self.assertEqual(retorno_esperado, teste)
    ...
    def test_12_Cria_tabuleiro_OK(self):
        ...
        print("Teste Módulo Tabuleiro - Caso de Teste 12 - Cria todas as casas do tabuleiro")
